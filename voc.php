...
echo "\e[96m           SUBCRIBE CHANNEL ABM GAMING :                \n";
echo "\e[96m                 ABM CHEFAO GANS V:                     \n";
echo "\e[96m            * CREATED BY  : ABMCHEFAO *                 \n";
...
else
{
		echo "\e[96m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";	
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
		echo "\e[96m[🚫]        \e[91mKAN UDAH GUE BILANG ANJG V:     \e[96m [🚫]\n";
	        echo "\e[96m[🚫]              \e[91mKLIK ENTER AJA ...    \e[96m [🚫]\n";
		echo "\e[96m[🚫]           \e[91mMASIH AJA NGEYEL LU NYET     \e[96m [🚫]\n";
...
ulang:
echo "\n";
echo "\e[96m ( BILANG GUWE GANS DULU YA $input)        \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
// function change(){
        $nama = nama();
        ...
        echo "\n".color("yellow","# NGACENGKAN , WKWKWKWK ");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        }
        ...
        echo "\n".color("yellow","# SABAR YA NYET , DIKIT LAGI KOK BIAR UWU");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(5);
        }
        ...
        $TOKEN  = "0000000000:7V93cvCvw1DNuTk0Hp1ZFywJGmjiP7aQ";
         ...
         setpin:
         echo "\n".color("purple","🔧▶️ SET PIN GOPAY SEKALIAN GAK ? !!!: Y/N ");
         ...
         echo color("red","-] Nomor udah keregist SAD BOI.");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("purple","!] Coba Nomer Fresh Lainnya V: \n");
         goto ulang;
         }
//  }
